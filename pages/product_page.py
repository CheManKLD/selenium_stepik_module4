...
class ProductPage(BasePage):
    ...
    def should_be_product_name_in_success_message(self):
        ...
        message = self.browser.find_element(
            *ProductPageLocators.PRODUCT_NAME_IN_SUCCESS_MESSAGE_AFTER_ADD_TO_BASKET).text
    ...
    def should_be_product_price_in_success_message(self):
        ...
        message = self.browser.find_element(
            *ProductPageLocators.PRODUCT_PRICE_IN_SUCCESS_MESSAGE_AFTER_ADD_TO_BASKET).text
